#!/bin/bash
###############################################################################
# Qwen3-VL-30B-A3B-Instruct 全参 SFT 续训脚本 (12w pixels, 续训到5epoch)
#
...
CONFIG_FILE="${SCRIPT_DIR}/train_qwen3vl_30B_full_multi_gpu_12w_pixels_5epoch.yaml"
...
# ========================= 环境检查 =========================
echo "============================================================"
echo "  Qwen3-VL-30B-A3B 全参 SFT (12w pixels, 续训到5epoch)"
echo "============================================================"
echo ""
