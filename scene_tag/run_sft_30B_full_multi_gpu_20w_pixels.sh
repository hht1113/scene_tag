...
#
# 用法:
#   8卡训练:  bash run_sft_30B_full_multi_gpu_20w_pixels.sh
#   指定GPU:  CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash run_sft_30B_full_multi_gpu_20w_pixels.sh
#   多机训练: NNODES=2 NODE_RANK=0 MASTER_ADDR=192.168.0.1 MASTER_PORT=29500 bash run_sft_30B_full_multi_gpu_20w_pixels.sh
###############################################################################
...
CONFIG_FILE="${SCRIPT_DIR}/train_qwen3vl_30B_full_multi_gpu_20w_pixels.yaml"
...
# ========================= 环境检查 =========================
echo "============================================================"
echo "  Qwen3-VL-30B-A3B 全参 SFT 多卡训练 (DeepSpeed ZeRO-3 Offload, 20w pixels)"
echo "============================================================"
echo ""
