...
#
# 数据集:   qwen3_sft_train_segment_add_tags_upsample.json
...
CONFIG_FILE="${SCRIPT_DIR}/train_qwen3vl_30B_full_multi_gpu_add_tags.yaml"

cd "$PROJECT_DIR"

# ========================= 环境检查 =========================
echo "============================================================"
echo "  Qwen3-VL-30B-A3B 全参 SFT 多卡训练 (DeepSpeed ZeRO-3) + 添加场景标签"
echo "============================================================"
echo ""
