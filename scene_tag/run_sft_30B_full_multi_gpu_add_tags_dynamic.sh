#!/bin/bash
###############################################################################
# Qwen3-VL-30B-A3B-Instruct 全参 SFT 多卡分布式训练脚本 (添加场景标签)
#
...
CONFIG_FILE="${SCRIPT_DIR}/train_qwen3vl_30B_full_multi_gpu_add_tags_dynamic.yaml"
...
# ========================= 环境检查 =========================
echo "============================================================"
echo "  Qwen3-VL-30B-A3B 全参 SFT 多卡训练 (DeepSpeed ZeRO-3) + 动态采样场景标签"
echo "============================================================"
echo ""
