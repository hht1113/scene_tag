#!/bin/bash
###############################################################################
# Qwen3-VL-30B-A3B-Instruct 全参 SFT 续训脚本 (动态采样数据集, 续训到5epoch)
#
# 数据集:   qwen3_sft_train_segment_add_tags_dynamic_sample.json
# 微调方式: 全参微调 + DeepSpeed ZeRO-3 Offload
# 续训:     从2epoch checkpoint-432断点续训到5epoch
###############################################################################
...
CONFIG_FILE="${SCRIPT_DIR}/train_qwen3vl_30B_full_multi_gpu_add_tags_dynamic_5epoch.yaml"
...
# ========================= 环境检查 =========================
echo "============================================================"
echo "  Qwen3-VL-30B-A3B 全参 SFT (动态采样, 续训到5epoch)"
echo "============================================================"
echo ""
...
DATASET_FILE="${PROJECT_DIR}/data/qwen3_sft_train_segment_add_tags_dynamic_sample.json"
