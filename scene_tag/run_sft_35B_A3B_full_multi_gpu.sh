#!/bin/bash
###############################################################################
# Qwen3.5-35B-A3B-Instruct 全参 SFT 多卡分布式训练脚本
#
...
CONFIG_FILE="${SCRIPT_DIR}/train_qwen3.5_35B_A3B_full_8gpu.yaml"

cd "$PROJECT_DIR"

# ========================= 环境检查 =========================
echo "============================================================"
echo "  Qwen3.5-35B-A3B-Instruct 全参 SFT 多卡训练 (DeepSpeed ZeRO-3)"
echo "============================================================"
echo ""
