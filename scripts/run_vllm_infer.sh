...
python scripts/vllm_infer.py \
    ...
    --adapter_name_or_path "/root/workspace/LLaMA-Factory/saves/Qwen3-VL-4B-Instruct/lora/train_2026-01-23-17-10-18_upstream/checkpoint-275" \
    --dataset "digged_dataset" \
    --template "qwen3_vl_nothink" \
    --save_name "/root/workspace/LLaMA-Factory/infer_results/12tags_Qwen3-VL-4B_segment_upstream_1epoch_digged.jsonl" \
    --cutoff_len 15000 \
    --max_new_tokens 512 \
    --batch_size 1 \
    --video_fps 2.0 \
